...
# command reference and isolated extensions, then the small top-level menu override.
...
. (Join-Path $root 'modules\WiFiCredentialTools.ps1')
. (Join-Path $root 'modules\NotepadSessionTools.ps1')
